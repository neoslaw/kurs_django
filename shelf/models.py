# -*- coding: utf-8 -*-
from __future__ import unicode_literals, absolute_import, print_function # importy z przyszłośći jako pierwsze przed jakim kolwiek kodem 
...
COVER_TYPES = (
    ('soft', 'Soft'),
    ('hard', 'Hard')
   #(wartośc_w_bazie, wartość_wyświetlana)
